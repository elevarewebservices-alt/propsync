...
function LoginPageContent() {
  ...
  // Google/Microsoft OAuth runs through a browser redirect that Google blocks
  // inside an in-app WebView (and the redirect_uri doesn't match the native
  // context). Hide the social buttons in the native app — email/password works
  // everywhere. (Native social sign-in is a later, plugin-based enhancement.)
